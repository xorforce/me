        ...
        <section className='mb-16'>
          ...
          <div className='space-y-8'>
            {talksData.talks.map((talk) => (
              <Card key={talk.id} className='group hover:bg-gray-50 dark:hover:bg-gray-800 transition-all duration-200 border-none shadow-none hover:scale-[1.005] transition-transform duration-200'>
